...
struct node {
    int data1; //First integer
    int data2; //Second integer
    struct node *next; //Pointer to next node

    node (int data1, int data2){ //Constructor used to add new node
        this->data1 = data1;
        this->data2 = data2;
        next = NULL;
    }
...
class LinkedList {
    ...
    public:
        ...
        void append(int data1, int data2){
...
{
    int a, b; //Two integers to be added
