...
int main() {
  ...
  vec.push_back(make_pair(2500, "halim"));
  vec.push_back(make_pair(1500, "junan"));
  vec.push_back(make_pair(700, "guy"));
  priority_queue< pair<int, string>,
  vector<pair<int,string>>,
  greater<pair<int,string>> > pq(vec.begin(), vec.end());             // introducing 'pair'
